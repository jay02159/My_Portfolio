    ...
    <PageContainer>
      ...
      <div className="bg-zinc-900 rounded-3xl p-6">
        <button 
          ...
          className="w-full flex items-center justify-center gap-2 bg-grey-200 hover:bg-white-50 text-black font-semibold py-3 rounded-xl transition-colors duration-300 ease-in-out"
        >
          <Download size={20} />
          Download CV
        </button>
